...
public class FirstTest {
        ...
        WebElement pageTitelWE = driver.findElement(By.tagName("h1"));
        String pageTitle = pageTitelWE.getText();
        //System.out.println(pageTitle); было для поски и проверки слова элемент
